...
$insert_sql = "INSERT INTO users (USER_EMAIL, PHONE_NUMBER, TYPE_ID, PASSWORD, FULL_NAME ,provider) VALUES (?, ?, ?, ?, ?,?)";
$insert_stmt = $conn->prepare($insert_sql);
$insert_stmt->bind_param("ssisss", $email, $phone, $type_id, $password, $fullname , $provider);
